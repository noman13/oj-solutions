...
int main()
{
    ...
    mpp.insert({"purple", "Power"});
    mpp.insert({"green", "Time"});
    mpp.insert({"blue", "Space"});
    mpp.insert({"orange", "Soul"});
    mpp.insert({"red", "Reality"});
    mpp.insert({"yellow", "Mind"});
    ...
    cout << 6-n << endl;
    for(auto i : mpp){
        if(i.second!="NULL") cout << i.second << endl;
    }

...
int main()
{
    ...
    while(t--){
        ...
        a1 = s.substr(0, 4) + s.substr(n, 0);
        a2 = s.substr(0, 3) + s.substr(n-1, 1);
        a3 = s.substr(0, 2) + s.substr(n-2, 2);
        a4 = s.substr(0, 1) + s.substr(n-3, 3);
        a5 = s.substr(0, 0) + s.substr(n-4, 4);
        // cout << a1 << " " << a2 << " " << a3 << " " << a4 << " " << a5 << endl; 
        string yy = "2020";
        if(a1==yy || a2==yy || a3==yy || a4==yy || a5==yy) f = true;
